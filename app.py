...
def dashboard_page() -> None:
    ...
    try:
        ...
        if not df.empty:
            ...
            display_df = df.rename(columns={"GUARDIAN": "Guardian", "TOTAL_XP": "Total XP"})[
                ["Rank", "Guardian", "Total XP"]
            ]
            st.markdown(
                """
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    "Guardian": st.column_config.TextColumn(),
                    "Total XP": st.column_config.NumberColumn(format="%d XP"),
                },
            )
            st.markdown(
                """
